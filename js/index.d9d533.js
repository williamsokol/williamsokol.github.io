...
var a='data-src';var e=document.querySelector('.un12');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/williamsokol-532.png':'images/williamsokol-266.png');};
...
wl.addAnimation($('.un10'), "3.00s", "0.00s", 1, 100);
wl.addAnimation($('.un13'), "3.00s", "0.00s", 1, 100);
wl.start();
...
});lfn=function(){ldsrcset('.un14 source');ldsrcset('.un15 source');ldsrcset('.un16 source');ldsrcset('.un17 source');ldsrcset('.un18 source');ldsrcset('.un19 source');ldsrcset('.un20 source');ldsrcset('.un21 source');};if(document.readyState=="complete"){lfn();}else{$(window).on("load",lfn);}