...
var a='data-src';var e=document.querySelector('.un11');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/william-802.png':'images/william-401.png');
var a='data-src';var e=document.querySelector('.un13');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/william-802.png':'images/william-401.png');
var a='data-src';var e=document.querySelector('.un15');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/william-802-1.png':'images/william-401-1.png');
};
...
wl.addAnimation($('.un10'), "3.00s", "3.00s", 1, 100);
wl.addAnimation($('.un12'), "1.00s", "0.00s", 1, 100);
wl.addAnimation($('.un14'), "2.00s", "0.00s", 1, 100);
wl.addAnimation($('.un16'), "3.00s", "0.00s", 1, 100);
wl.addAnimation($('.un17'), "1.00s", "3.00s", 1, 100);
wl.addAnimation($('.un19'), "1.00s", "3.00s", 1, 100);
wl.start();
